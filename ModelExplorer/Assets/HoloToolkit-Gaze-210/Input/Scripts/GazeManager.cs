...
namespace Academy.HoloToolkit.Unity
{
    ...
    public class GazeManager : Singleton<GazeManager>
    {
        ...
        private Vector3 unstabilizedGazeOrigin;
        ...
        private void Update()
        {
            ...
            unstabilizedGazeOrigin = gazeOrigin = Camera.main.transform.position;
            ...
            //Debug.Log(string.Format("unstabilized {0}.{1}.{2}", unstabilizedGazeOrigin.x, unstabilizedGazeOrigin.y, unstabilizedGazeOrigin.z));
            //Debug.Log(string.Format("stabilized {0}.{1}.{2}", gazeOrigin.x, gazeOrigin.y, gazeOrigin.z));
            //Debug.Log(string.Format("dx{0} dy{1} dz{2}", unstabilizedGazeOrigin.x - gazeOrigin.x, unstabilizedGazeOrigin.y - gazeOrigin.y, unstabilizedGazeOrigin.z - gazeOrigin.z));
        ...
        private void UpdateRaycast()
        {
            ...
            Hit = Physics.Raycast(gazeOrigin, gazeDirection, out hitInfo,
                           MaxGazeDistance,
                           RaycastLayerMask);
